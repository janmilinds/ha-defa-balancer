...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `DEFABalancer`
...
- Inherit from both platform entity and `DEFABalancerEntity` (order matters)
...
from custom_components.defa_balancer.sensor import async_setup_entry
...
**Config entry data:** `entry_data: DEFABalancerData = hass.data[DOMAIN][entry.entry_id]`

...
- **`entity/`** - Base entity classes (inherit `DEFABalancerEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, DEFABalancerEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import DEFABalancerEntity`

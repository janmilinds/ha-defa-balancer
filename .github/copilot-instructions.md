...
- **Main code:** `custom_components/defa_balancer/`
...
- `entity/` — Base entity class (`DEFABalancerEntity`)
...
- Entity MRO: `(PlatformEntity, DEFABalancerEntity)` — order matters
...
- Debug level: `custom_components.defa_balancer: debug` in `config/configuration.yaml`

...
**File:** `custom_components/defa_balancer/services.yaml`
...
Create `custom_components/defa_balancer/service_actions/[action_name].py`:

```python
"""[Action name] service action for DEFA Balancer."""
...
**File:** `custom_components/defa_balancer/__init__.py`
...
**File:** `custom_components/defa_balancer/const.py`
...
3. Find service action: `defa_balancer.[action_name]`
...
- **Service actions directory:** `custom_components/defa_balancer/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/defa_balancer/services.yaml` (legacy filename)
- **Icons:** `custom_components/defa_balancer/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/defa_balancer/translations/*.json` under `services` key (legacy)

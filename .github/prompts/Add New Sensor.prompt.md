...
- Create new sensor file in `custom_components/defa_balancer/sensor/`
- Inherit from `DEFABalancerEntity` and `SensorEntity`
...
```python
"""[Sensor description] for DEFA Balancer."""
...
class DEFABalancer[SensorName]Sensor(
    DEFABalancerEntity,
    SensorEntity,
):
...
- Entity: `custom_components/defa_balancer/sensor/[sensor_name].py`
- Platform: `custom_components/defa_balancer/sensor/__init__.py`
- Translations: `custom_components/defa_balancer/translations/*.json`

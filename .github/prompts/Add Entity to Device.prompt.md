...
- Inherit from `DEFABalancerEntity` and platform base class
...
- Entity: `custom_components/defa_balancer/[platform]/[entity_name].py`
- Platform: `custom_components/defa_balancer/[platform]/__init__.py`

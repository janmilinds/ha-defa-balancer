...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=ha-defa-balancer&category=integration)
...
Find all entities in **Settings** → **Devices & Services** → **DEFA Balancer** → click on the device.
...
```yaml
service: defa_balancer.example_action
data:
  # Add your parameters here
```

### `defa_balancer.reload_data`
...
```yaml
service: defa_balancer.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → DEFA Balancer → 3 dots → Download diagnostics)

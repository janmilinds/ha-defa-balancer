"""
Core DataUpdateCoordinator implementation for defa_balancer.
...
from custom_components.defa_balancer.api import DEFABalancerApiClientAuthenticationError, DEFABalancerApiClientError
...
class DEFABalancerDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    async def _async_update_data(self) -> Any:
        ...
        except DEFABalancerApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="defa_balancer",
                translation_key="authentication_failed",
            ) from exception
        except DEFABalancerApiClientError as exception:
